...
The present work consists of two studies leveraging machine learning, each based on a separate dataset. The workflow of data collection, processing, and predictive modeling is described in detail in the following section and illustrated in Figure \@ref(fig:methodsoverview).
