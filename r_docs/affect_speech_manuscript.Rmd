...
```{r experiencevsexpression, echo = FALSE, warning=FALSE, fig.cap="The difference of subjective affect experience and observable affect expression.", fig.scap= "Feature importance", out.width="100%", fig.align="center", results="asis"}

knitr::include_graphics(path = "../figures/experienc_vs_expression.png")
```
...
Also, models trained only on voice acoustics or word embedding respectively revealed that predictions were mostly driven by the information coming from speech content as represented in the word embeddings. 
