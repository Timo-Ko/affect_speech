...
bmr_egemaps <- readRDS("../results/study1/bmr_egemaps.RData") 
...
bmr_egemaps_wordembeddings <- readRDS("../results/study2/bmr_egemaps_wordembeddings.RData")
...
knitr::include_graphics(path = "../figures/importance_rf_arousal_plot.png")
```
